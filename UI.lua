...
if game.CoreGui:FindFirstChild('ArtteroUiLib') then
    game.CoreGui:FindFirstChild('ArtteroUiLib'):Destroy()
    destroyed = true
end
...
local ArtteroUiLib = Instance.new("ScreenGui")

ArtteroUiLib.Name = "ArtteroUiLib"

protect_gui(ArtteroUiLib)
...
function library:Destroy()
    ArtteroUiLib:Destroy()
    if keybindConnection then
        keybindConnection:Disconnect()
    end
end
function library:Hide()
   ArtteroUiLib.Enabled = not ArtteroUiLib.Enabled
end	
...
function library:Window(name) 
    ...
    UiWindow.Parent = ArtteroUiLib
    UiWindow.BackgroundColor3 = Color3.fromRGB(0, 220, 0)
    UiWindow.BorderColor3 = Color3.fromRGB(0, 220, 0)
    ...
    Header.BackgroundColor3 = Color3.fromRGB(0, 220, 0)
    Header.BorderColor3 = Color3.fromRGB(0, 220, 0)
    ...
    HeaderText.TextColor3 = Color3.fromRGB(35, 35, 35)
    ...
    Minimise.BackgroundColor3 = Color3.fromRGB(0, 220, 0)
    Minimise.BorderColor3 = Color3.fromRGB(0, 220, 0)
    ...
    function functions:Button(name, callback)
        ...
        Button.BorderColor3 = Color3.fromRGB(0, 70, 0)
    ...
    function functions:Toggle(text, on, callback)
        ...
        ToggleButton.BorderColor3 = Color3.fromRGB(0, 70, 0)
        ...
        ToggleFiller.BorderColor3 = Color3.fromRGB(35, 35, 35)
    ...
    function functions:Box(text, callback)
        ...
        TextBox.BorderColor3 = Color3.fromRGB(0, 70, 0)
    ...
    function functions:Slider(text, min, max, default, callback)
        ...
        Slider.BorderColor3 = Color3.fromRGB(0, 70, 0)
        ...
        SliderButton.BorderColor3 = Color3.fromRGB(0, 70, 0)
        ...
        SilderFiller.BorderColor3 = Color3.fromRGB(35, 35, 35)
    ...
    function functions:Dropdown(text, buttons, callback, selective)
        ...
        Dropdown.BorderColor3 = Color3.fromRGB(0, 70, 0)
        ...
        function dropFunctions:Button(name)
            ...
            Button_2.BorderColor3 = Color3.fromRGB(0, 70, 0)
    ...
    function functions:ColorPicker(name, default, callback)
        ...
        ColorPickerFrame.BorderColor3 = Color3.fromRGB(35, 35, 35)
        ...
        ToggleRGB.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
        ToggleRGB.BorderColor3 = Color3.fromRGB(0, 70, 0)
        ...
        ToggleFiller_2.BorderColor3 = Color3.fromRGB(35, 35, 35)
        ...
        ClosePicker.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
        ClosePicker.BorderColor3 = Color3.fromRGB(35, 35, 35)
        ...
        if default and type(default) == "boolean" then
            ...
            ColorPicker.BackgroundColor3 = default or Color3.fromRGB(0, 220, 0)
        end
